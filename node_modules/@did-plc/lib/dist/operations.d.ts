...
export declare const didForCreateOp: (op: t.CompatibleOp, truncate?: number) => Promise<string>;
...
export declare const updateAtprotoKeyOp: (lastOp: t.CompatibleOp, signer: Keypair, atprotoKey: string) => Promise<t.Operation>;
export declare const updateHandleOp: (lastOp: t.CompatibleOp, signer: Keypair, handle: string) => Promise<t.Operation>;
export declare const updatePdsOp: (lastOp: t.CompatibleOp, signer: Keypair, endpoint: string) => Promise<t.Operation>;
...
export declare const assureValidOp: (op: t.OpOrTombstone) => Promise<true | undefined>;
export declare const assureValidCreationOp: (did: string, op: t.CompatibleOpOrTombstone) => Promise<t.DocumentData>;
export declare const assureValidSig: (allowedDids: string[], op: t.CompatibleOpOrTombstone) => Promise<string>;
